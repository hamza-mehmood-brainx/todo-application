...
// Function to render todos
  function renderTodos(list) {
    ...
    if (!list.length) {
      tableBody.innerHTML = '<tr><td colspan="3" class="text-center text-muted">No todos found.</td></tr>';
      return;
    }
...
// Function to filter todos
 ...
 async function loadTodosFromAPI() {
    ...
    //  Checking if already todo exist
      ...
      tableBody.innerHTML = '<tr><td colspan="3" class="text-danger">Failed to load todos from API.</td></tr>';
    }
    finally {
